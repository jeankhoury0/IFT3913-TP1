...
/**
 * Représente un automate pour l'analyse des mots-clés <b>{@code for}</b> à l'intérieur du code Java.
 ...
 */
public enum AutomateFor implements AutomateJava {
    /**
    ...
    Initial {
        ...
        @Override
        public AutomateFor prochainEtat(char prochainChar) {
            return null;
        }
    }
    // TODO: construire l'automate for
}
