...
/**
 * Représente un automate pour l'analyse des mots-clés <b>{@code if}</b> à l'intérieur du code Java.
 ...
 */
public enum AutomateIf implements AutomateJava {
    /**
    ...
    Initial {
        ...
        @Override
        public AutomateIf prochainEtat(char prochainChar) {
            return null;
        }
    }
    // TODO: construire l'automate if
}
