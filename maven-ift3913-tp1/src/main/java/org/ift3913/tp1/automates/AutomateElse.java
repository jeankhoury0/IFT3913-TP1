...
/**
 * Représente un automate pour l'analyse des mots-clés <b>{@code else}</b> à l'intérieur du code Java.
 ...
 */
public enum AutomateElse implements AutomateJava {
    /**
    ...
    Initial {
        ...
        @Override
        public AutomateElse prochainEtat(char prochainChar) {
            return null;
        }
    }
    // TODO: construire l'automate else
}
