...
/**
 * Représente un automate pour l'analyse des mots-clés <b>{@code while}</b> à l'intérieur du code Java.
 ...
 */
public enum AutomateWhile implements AutomateJava {
    /**
    ...
    Initial {
        ...
        @Override
        public AutomateWhile prochainEtat(char prochainChar) {
            return null;
        }
    }
    // TODO: construire l'automate while
}
